...
from TuioCallback import TuioCallback
...
class Tracking(object):
    ...
    def open_socket(self):
        ...
        # set a timeout here so that update() does return somewhen
            ...
            if profile is not None:
                try:
                    ...
                    if command == 'set' or command == 'add':
                        ...
                        self.eventManager.notifyRemove_listeners((profile, message))
